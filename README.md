...
No se trata solo de mezclar cosas, existe una integración profunda (no es poner un medio al lado del otro sin más) creando una nueva experiencia o lenguaje y el software es quien actua permitiendo esa unión.
El software convierte el medio en datos que se pueden manipular y combinar libremente surgiendo así un metamedio donde coexisten todos los medios. 
